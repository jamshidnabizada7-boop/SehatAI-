...
export const EMERGENCY_TEMPLATES: EmergencyTemplate[] = [
  ...
  // ============================================================
  {
    patternCategory: 'burns',
    title: {
      en: 'Severe burn — act now',
      ur: 'شدید جلن — فوری اقدام کریں',
      roman: 'Shadeed jalan — fori iqdam karein',
    },
    reasonIntro: {
      en: 'Severe burns, especially on face, hands, genitals, or large areas, need emergency care.',
      ur: 'شدید جلن، خاص طور پر چہرے، ہاتھوں، شرمگاہ یا بڑے حصے پر، کو فوری ہسپتال لے جانا ضروری ہے۔',
      roman: 'Shadeed jalan, khaas tor par chehre, haathon, sharmgah ya bare hissay par, ko fori hospital le jana zaroori hai.',
    },
    immediateActions: [
      {
        en: 'Cool the burn under running (cold) water for 20 minutes.',
        ur: 'جلن کو 20 منٹ بہتے ٹھنڈے پانی سے ٹھنڈا کریں۔',
        roman: 'Jalan ko 20 minute bahte thande pani se thanda karein.',
      },
      {
        en: 'Remove jewellery/tight clothing near the burn if you can, before swelling starts.',
        ur: 'جلن کے پاس کے زیورات یا تنگ کپڑے نکالیں اگر ہو سکے، سوجن سے پہلے۔',
        roman: 'Jalan ke paas ke zewar ya tang kapray nikalein agar ho sake, soojan se pehle.',
      },
      {
        en: 'Cover loosely with a clean cloth or cling film.',
        ur: 'صاف کپڑے یا کلنگ فلم سے ڈھیلا ڈھانپ لیں۔',
        roman: 'Saaf kapray ya cling film se dheela dhaanp lein.',
      },
      {
        en: 'Call 1122 if the burn is large, on face/hands/genitals, or the person is a child or elderly.',
        ur: 'اگر جلن بڑی ہو، چہرے/ہاتھوں/شرمگاہ پر ہو، یا مریض بچہ یا بزرگ ہو تو 1122 پر کال کریں۔',
        roman: 'Agar jalan bare ho, chehre/haathon/sharmgah par ho, ya mareez bacha ya buzurg ho to 1122 par call karein.',
      },
    ],
    doNot: [
      {
        en: 'Do not apply toothpaste, butter, oil, creams, or ice directly.',
        ur: 'ٹوتھ پیسٹ، مکھن، تیل، کریم، یا برف براہ راست نہ لگائیں۔',
        roman: 'Toothpaste, makkhan, tail, cream, ya barf barah-e-raast na lagayein.',
      },
      {
        en: 'Do not burst any blisters.',
        ur: 'آبلے پھاڑنے کی کوشش نہ کریں۔',
        roman: 'Aabley phaarne ki koshish na karein.',
      },
      {
        en: 'Do not peel off clothing stuck to the burn.',
        ur: 'جلن سے چپکے کپڑے نہ نوچیں۔',
        roman: 'Jalan se chipke kapray na nochhein.',
      },
    ],
  ...
  },
  {
    patternCategory: 'head-injury',
    title: {
      en: 'Head injury — emergency care',
      ur: 'سر کی چوٹ — ایمرجنسی علاج',
      roman: 'Sar ki chot — emergency ilaaj',
    },
    reasonIntro: {
      en: 'A head injury with vomiting, confusion, unequal pupils, seizure, or fluid from ear/nose needs urgent assessment.',
      ur: 'سر کی چوٹ کے ساتھ الٹی، الجھن، بے برابر پتلیاں، دورہ، یا کان/ناک سے پانی آنے کے لیے فوری معائنہ ضروری ہے۔',
      roman: 'Sar ki chot ke saath ulti, uljhan, be-barabar putliyan, dorra, ya kaan/naak se pani anay ke liye fori muaina zaroori hai.',
    },
    immediateActions: [
      {
        en: 'Call 1122 — keep the person still, do not move the neck.',
        ur: '1122 پر کال کریں — مریض کو سکون سے رکھیں، گردن نہ ہلائیں۔',
        roman: '1122 par call karein — mareez ko sukoon se rakhein, gardan na hilayein.',
      },
      {
        en: 'If unconscious but breathing, place in the recovery position (on their side).',
        ur: 'اگر بےہوش ہو لیکن سانس چل رہی ہو تو بائیں کرو پھیر دیں۔',
        roman: 'Agar behosh ho lekin saans chal rahi ho to baen karou phir dein.',
      },
      {
        en: 'Note the time of injury and any loss of consciousness — tell the ambulance crew.',
        ur: 'چوٹ کا وقت اور بےہوشی کا دورانیہ نوٹ کریں — ایمبولینس عملے کو بتائیں۔',
        roman: 'Chot ka waqt aur behoshi ki dawaniya note karein — ambulance amlay ko batayein.',
      },
      {
        en: 'Stop any bleeding from the scalp with gentle pressure (do not press if skull looks dented).',
        ur: 'کھوپڑی سے خون کو ہلکے دباؤ سے روکیں (اگر کھوپڑی دب جائے تو دباؤ نہ دیں)۔',
        roman: 'Khopdi se khoon ko halkay dabao se rokein (agar khopdi dab jaye to dabao na dein).',
      },
    ],
    doNot: [
      {
        en: 'Do not give food or drink.',
        ur: 'کھانا یا پانی نہ دیں۔',
        roman: 'Khana ya pani na dein.',
      },
      {
        en: 'Do not move the person if a neck/spine injury is possible.',
        ur: 'اگر گردن/ریڑھ کی ہڈی کی چوٹ ممکن ہو تو مریض کو ہلانا نہیں۔',
        roman: 'Agar gardan/rerh ki haddi ki chot mumkin ho to mareez ko hilana nahin.',
      },
      {
        en: 'Do not leave them alone — watch for deterioration.',
        ur: 'انہیں اکیلا نہ چھوڑیں — خرابی کے لیے دیکھیں۔',
        roman: 'Inhein akela na chhorhein — kharabi ke liye dekhein.',
      },
    ],
  ...
  },
  {
    patternCategory: 'poisoning',
    title: {
      en: 'Poisoning — call for help now',
      ur: 'زہر — فوری مدد کے لیے کال کریں',
      roman: 'Zehr — fori madad ke liye call karein',
    },
    reasonIntro: {
      en: 'Poisoning, snakebite, or chemical ingestion needs urgent assessment.',
      ur: 'زہر، سانپ کا کاٹا، یا کیمیکل کا استعمال فوری معائنے کا متقاضی ہے۔',
      roman: 'Zehr, saanp ka kaata, ya chemical ka istemal fori muainay ka mutaqazi hai.',
    },
    immediateActions: [
      {
        en: 'Call 1166 (Health Helpline) or 1122 now — say what was swallowed, how much, and when.',
        ur: 'فوراً 1166 (ہیلتھ ہیلپ لائن) یا 1122 پر کال کریں — بتائیں کیا نگلا، کتنا، اور کب۔',
        roman: 'Fori 1166 (Health Helpline) ya 1122 par call karein — batayein kya nigla, kitna, aur kab.',
      },
      {
        en: 'Bring the container, bottle, or plant to the hospital.',
        ur: 'بوتل، ڈبہ، یا پودا ہسپتال لے جائیں۔',
        roman: 'Bottle, dabba, ya pauda hospital le jayein.',
      },
      {
        en: 'For snakebite: keep the bitten limb still and below heart level if possible; remove rings/watch before swelling.',
        ur: 'سانپ کے کاٹے پر: کٹے ہوئے حصے کو سکون اور اگر ہو سکے دل سے نیچے رکھیں؛ سوجن سے پہلے انگوٹی/گھڑی نکالیں۔',
        roman: 'Saanp ke kaatay par: kate hue hissay ko sukoon aur agar ho sake dil se neeche rakhein; soojan se pehle angooti/ghari nikalein.',
      },
      {
        en: 'If unconscious but breathing, place in the recovery position.',
        ur: 'اگر بےہوش ہو لیکن سانس چل رہی ہو تو بائیں کرو پھیر دیں۔',
        roman: 'Agar behosh ho lekin saans chal rahi ho to baen karou phir dein.',
      },
    ],
    doNot: [
      {
        en: 'Do NOT induce vomiting unless Poison Control / 1166 tells you to.',
        ur: 'زہر قے نہ کرائیں جب تک ہیلتھ ہیلپ لائن (1166) نہ کہے۔',
        roman: 'Zehr qay na karayein jab tak health helpline (1166) na kahe.',
      },
      {
        en: 'Do not give milk, water, or anything by mouth if drowsy/unconscious.',
        ur: 'اگر نیند میں یا بےہوش ہو تو دودھ، پانی، یا کچھ نہ دیں۔',
        roman: 'Agar neend mein ya behosh ho to doodh, pani, ya kuch na dein.',
      },
      {
        en: 'Do not apply anything to a snakebite (no incisions, no tourniquet, no ice).',
        ur: 'سانپ کے کاٹے پر کچھ نہ لگائیں (نہ چیرا، نہ رگڑ، نہ برف)۔',
        roman: 'Saanp ke kaatay par kuch na lagayein (na cheera, na ragar, na barf).',
      },
    ],
  ...
  },
  {
    patternCategory: 'anaphylaxis',
    title: {
      en: 'Severe allergic reaction — act now',
      ur: 'شدید الرجک ردعمل — فوری اقدام کریں',
      roman: 'Shadeed allergic reaction — fori iqdam karein',
    },
    reasonIntro: {
      en: 'Rapid swelling of lips, tongue, or throat with trouble swallowing or breathing is anaphylaxis.',
      ur: 'ہونٹ، زبان، یا گھٹنے کی تیزی سے سوجن اور نگلنے یا سانس لینے میں مشکل — اینا فلیکسس ہے۔',
      roman: 'Hont, zabaan, ya ghatne ki tezi se soojan aur nigalne ya saans lene mein mushkil — anaphylaxis hai.',
    },
    immediateActions: [
      {
        en: 'Call 1122 now.',
        ur: 'فوراً 1122 پر کال کریں۔',
        roman: 'Fori 1122 par call karein.',
      },
      {
        en: 'If an EpiPen (adrenaline auto-injector) was prescribed, use it on the outer thigh through clothing if needed.',
        ur: 'اگر EpiPin (ایڈرینالین آٹو انجیکٹر) تجویز ہو تو ران کے باہر حصے پر، ضرور ہو تو کپڑوں کے ساتھ، استعمال کریں۔',
        roman: 'Agar EpiPen (adrenaline auto-injector) tayoon ho to raan ke bahar hissay par, zaroor ho to kapron ke saath, istemal karein.',
      },
      {
        en: 'If breathing is hard, sit them up; if they feel faint, lie them flat with legs raised.',
        ur: 'اگر سانس مشکل ہو تو بٹھائیں؛ اگر چکر آئے تو لیٹائیں اور پاؤں اوپر اٹھائیں۔',
        roman: 'Agar saans mushkil ho to bithayein; agar chakar aaye to litayein aur paon oopar uthayein.',
      },
      {
        en: 'If no EpiPen or symptoms return after one — go to hospital immediately.',
        ur: 'اگر EpiPen نہ ہو یا علامات واپس آئیں — فوراً ہسپتال جائیں۔',
        roman: 'Agar EpiPen na ho ya alamaat wapas aayein — fori hospital jayein.',
      },
    ],
    doNot: [
      {
      ...
      {
        en: 'Do not let them stand or walk.',
        ur: 'انہیں کھڑا یا چلنے نہ دیں۔',
        roman: 'Inhein khada ya chalne na dein.',
      },
    ],
  ...
  },
  {
    patternCategory: 'obstetric-emergency',
    title: {
      en: 'Obstetric emergency — act now',
      ur: 'حمل کی ایمرجنسی — فوری اقدام کریں',
      roman: 'Hamal ki emergency — fori iqdam karein',
    },
    reasonIntro: {
      en: 'Bleeding, severe headache with vision change, seizure, or severe abdominal pain in pregnancy needs emergency care.',
      ur: 'حمل میں خون بہنا، نظر کے ساتھ شدید سر درد، دورہ، یا شدید پیٹ درد کو فوری علاج درکار۔',
      roman: 'Hamal mein khoon behna, nazar ke saath sakht sar dard, dorra, ya sakht pait dard ko fori ilaaj darkaar.',
    },
    immediateActions: [
      {
        en: 'Call 1122 now — say "I am pregnant and bleeding / having a seizure / severe headache."',
        ur: 'فوراً 1122 پر کال کریں — بتائیں "میں حاملہ ہوں اور خون بہہ رہا ہے / دورہ پڑا ہے / شدید سر درد ہے۔"',
        roman: 'Fori 1122 par call karein — batayein "mein hamila hoon aur khoon beh raha hai / dorra para hai / sakht sar dard hai."',
      },
      {
        en: 'Lie on your left side.',
        ur: 'بائیں کرو لیٹ جائیں۔',
        roman: 'Baen karou leit jayein.',
      },
      {
        en: 'Do not insert anything vaginally; bring any passed tissue/clots to the hospital.',
        ur: 'اندر کچھ نہ ڈالیں؛ اگر کوئی ٹشو یا لوتھڑا نکلا ہو تو ہسپتال لے جائیں۔',
        roman: 'Andar kuch na daalein; agar koi tissue ya lothra nikla ho to hospital le jayein.',
      },
    ],
    doNot: [
      {
        en: 'Do not wait to see if bleeding stops on its own.',
        ur: 'خون خود رک جائے گا، اس کا انتظار نہ کریں۔',
        roman: 'Khoon khud ruk jaye ga, is ka intezar na karein.',
      },
      {
        en: 'Do not take any medicine without a doctor saying so.',
        ur: 'ڈاکٹر کے کہے بغیر کوئی دوا نہ لیں۔',
        roman: 'Doctor ke kahe baghair koi dawa na lein.',
      },
    ],
